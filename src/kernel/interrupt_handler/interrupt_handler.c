...
static void mm_get_free_memory_handler (u16 UNUSED (msg), u16 raw_ptr, u16 UNUSED (raw_ptr), u16 UNUSED (arg3));
...
Int_handler *int_handler_allocate (u16 nb_hardware) {
    ...
    int_table[SOFTINT_GET_FREE_MEMORY] = mm_get_free_memory_handler;
